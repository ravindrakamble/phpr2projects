<?php $this->load->view('include/admin_header');?>
	...
	?>	
	<form name='packagesform' id='packagesform' method='post' action='<?php echo base_url()?>admin/packages/local'>
	...
	<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
		...
		<tbody>
			...
			foreach($local as $a)
			{
				...
				<td>'.$a->CITY_NAME.'</td>
				<td>
				<a href="javascript: editlocal('.$a->ID.')" class="ajax btn edit" alt="Edit">
				<i class="icon-edit"></i>
				</a>&nbsp;&nbsp;
				<a href="'.base_url().'ajax/delete_local_package/'.$a->ID.'" class="delete_btn btn btn-danger remove" title="'.$a->LOCAL_NAME.'">
